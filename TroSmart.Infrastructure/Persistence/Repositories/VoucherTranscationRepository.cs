...
{
    public class VoucherTranscationRepository : GenericRepository<VoucherTranscation>, IVoucherTranscationRepository
    {
        public VoucherTranscationRepository(TroSmartDbContext context) : base(context)
        {
        }
    }
}